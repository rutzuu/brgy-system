                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div>
                            ...
                            <dd class="flex items-center text-sm text-gray-500 font-medium capitalize sm:mr-6">
                                ...
                                Branch: Barangay Holy Spirit Barangay Hall
                            </dd>
                    ...
                    <li>
                        ...
                        <span class="flex items-center space-x-4">
                            ...
                            <span class="flex flex-col text-gray-500 text-sm truncate">
                                <span class="truncate">Barangay Certificate to Juan Dela Cruz</span>
                                <span><span class="text-gray-900 font-medium">100</span> PHP</span>
                            ...
                            <tr class="bg-white">
                                ...
                                <div class="flex">
                                    ...
                                    <p class="text-gray-500 truncate group-hover:text-gray-900">
                                        Barangay Certificate to Juan Dela Cruz
                                    </p>
                                    </a>
                                </div>
                                </td>
